...
# -----------------------------------------------------------------------------
export LATCalibRoot=/sdf/group/fermi/ground/releases/calibrations/ #Old path: /afs/slac.stanford.edu/g/glast/ground/releases/calibrations/
export LATMonRoot=/sdf/group/fermi/ground/releases/monitor/ #Old path: /afs/slac.stanford.edu/g/glast/ground/releases/monitor/
